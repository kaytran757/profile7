...
const cityModels: Record<string, Model[]> = {
  ...
  dn: [
    ...
    { name: 'Cẩm Ly', age: 22, district: 'Thanh Khê', price: 11, height: 164, weight: 52, views: 151.8, tags: ['Chiều chuộng'], vip: true, image: 'https://pbs.twimg.com/media/HCXQeYlaAAAZlRl?format=jpg&name=large' },
    ...
    { name: 'Triều Tiên', age: 21, district: 'Cẩm Lệ', price: 10, height: 163, weight: 49, views: 124.9, tags: ['Qua đêm'], vip: false, image: 'https://pbs.twimg.com/media/HCXQeYlaAAAZlRl?format=jpg&name=large' },
  ...
  nt: [
    ...
    { name: 'Thi Thơ', age: 24, district: 'Vĩnh Phước', price: 13, height: 161, weight: 52, views: 128.4, tags: ['Qua đêm'], vip: false, image: 'https://pbs.twimg.com/media/HCXQeYlaAAAZlRl?format=jpg&name=large' },
